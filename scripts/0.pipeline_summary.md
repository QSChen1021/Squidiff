...
**功能**: 从 Seurat 对象提取 Mast Cell 数据并转换为 h5ad 格式
...
**输出** (保存在 `data/` 目录):
- `mast_cells_200genes.h5ad` - 主数据文件 (200 基因)
...
Squidiff/
├── data/                          # 数据目录
│   ├── mast_cells_200genes.h5ad   # 主数据文件
